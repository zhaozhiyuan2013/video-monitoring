...
#include "../../QCamera/QMyLearn/h264.h"
...
struct qt_meta_stringdata_H264_t {
    QByteArrayData data[5];
    char stringdata[33];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_H264_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_H264_t qt_meta_stringdata_H264 = {
    {
QT_MOC_LITERAL(0, 0, 4),
QT_MOC_LITERAL(1, 5, 3),
QT_MOC_LITERAL(2, 9, 0),
QT_MOC_LITERAL(3, 10, 9),
QT_MOC_LITERAL(4, 20, 11)
    },
    "H264\0okk\0\0set_frame\0QVideoFrame\0"
};
...
void H264::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        H264 *_t = static_cast<H264 *>(_o);
        switch (_id) {
        case 0: _t->okk(); break;
        case 1: _t->set_frame((*reinterpret_cast< const QVideoFrame(*)>(_a[1]))); break;
        default: ;
        }
...
const QMetaObject H264::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_H264.data,
      qt_meta_data_H264,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_H264.stringdata))
