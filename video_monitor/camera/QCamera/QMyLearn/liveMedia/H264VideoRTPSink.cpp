...
::createNew(UsageEnvironment& env, Groupsock* RTPgs, unsigned char rtpPayloadFormat) {
     //qDebug()<<"H264VideoRTPSink* H264VideoRTPSink 1 ";
...
::createNew(UsageEnvironment& env, Groupsock* RTPgs, unsigned char rtpPayloadFormat,
	    u_int8_t const* sps, unsigned spsSize, u_int8_t const* pps, unsigned ppsSize,
	    unsigned profile_level_id) {
     //qDebug()<<"H264VideoRTPSink* H264VideoRTPSink 2 ";
...
::createNew(UsageEnvironment& env, Groupsock* RTPgs, unsigned char rtpPayloadFormat,
   ...
   //  qDebug()<<"H264VideoRTPSink* H264VideoRTPSink 3 ";
...
char const* H264VideoRTPSink::auxSDPLine() {
     qDebug() << "H264VideoRTPSink::auxSDPLine() {  85 ";
  ...
  if (sps == NULL || pps == NULL) {
    //    qDebug() <<"H264VideoRTPSink::auxSDPLine() { sps";
  ...
  //    qDebug() <<"H264VideoRTPSink::auxSDPLine() { framerSource = (H264or5VideoStreamFramer*)(fOurFragmenter->inputSource());";
