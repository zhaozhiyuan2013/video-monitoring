...
OnDemandServerMediaSubsession::sdpLines() {
   // qDebug()<<"OnDemandServerMediaSubsession::sdpLines() { 51 ";
  if (fSDPLines == NULL) {
...
void OnDemandServerMediaSubsession::startStream(unsigned clientSessionId,
    ...
    qDebug()<<"OnDemandServerMediaSubsession::startStream(unsigned clientSessionId,";
...
::startPlaying(Destinations* dests,
  ...
  if (fRTCPInstance == NULL && fRTPSink != NULL) {
       qDebug()<<" void StreamState ::startPlaying (RTCPInstance::createNew((  453";
  ...
  if (dests->isTCP) {
    ...
    if (fRTPSink != NULL) {
        qDebug()<<" void StreamState ::startPlaying(fRTPSink->addStreamSocket(  463";
  ...
  if (!fAreCurrentlyPlaying && fMediaSource != NULL) {
    if (fRTPSink != NULL) {
        qDebug()<<"void StreamState ::startPlaying  fRTPSink->startPlaying  495 ";
