...
//    //  out << QString ( QTime::currentTime() );
      file.close();
  qDebug()<<" ByteStreamFileSource::doReadFromFile() {   138  count ==   " <<count ;
  qDebug()<<" ByteStreamFileSource::doReadFromFile() {   138   a ==   " <<a;
  qDebug()<<" ByteStreamFileSource::doReadFromFile() {   138   fMaxSize ==   " << fMaxSize;
  FILE *readdd ;
